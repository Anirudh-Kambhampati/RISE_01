...
// import initialTree from "./SidebarComps.js";
// import 'D:/react/rise/package.json';
...
//       setSt(({ collapsed }) => ({ collapsed: !collapsed }));
//     }
...
//             </h1>
//             <button onClick={setSt(initialState)}>Reset</button>
//             <pre>{JSON.stringify(st.tree, null, "  ")}</pre>
//           </StrollableContainer>
//         </div>
  ...
  handleContextClick = (e, { action, name: id }) => {
    ...
    switch (action) {
      case "rename":
        ...
        const response = Window.prompt("Please rename", renameObj.value.module);
        console.log(renameObj.value.module);
        if (response === "") {
          // ignore empty string
          return;
        }
